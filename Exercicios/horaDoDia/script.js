function carregar() {
   ...
   if(hora >= 0 && hora <= 6) {
        ...
        img.innerHTML = '<img src="img/boaMadrugada-240.jpg">'
        ...
        img.innerHTML = '<img src="img/bomDia-240.jpg">'
        window.document.body.style.background = 'blue'

    }else if(hora >= 12 && hora <= 18){

        msg.innerHTML += '<p> Boa tarde!!</p>'
        img.innerHTML = '<img src="img/boaTarde-240.jpg">'
        windom.document.body.style.background = 'red'

    }else if( hora > 18){

        msg.innerHTML += '<p> Boa noite!!</p>'
        img.innerHTML = '<img src="img/boaNoite-240.jpg">'
